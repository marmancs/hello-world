...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeBlogBundle', '/var/www/Symfony/app/Resources/AcmeBlogBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeBlogBundle', '/var/www/Symfony/src/Acme/BlogBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'port' => '5432', 'user' => 'postgres', 'password' => 'pgresql', 'driver' => 'pdo_pgsql', 'charset' => 'UTF8', 'driverOptions' => array()), $a, new \Doctrine\Common\EventManager(), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/var/www/Symfony/src/Acme/BlogBundle/Entity')), 'Acme\\BlogBundle\\Entity');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'a5e7b1cecdda9fb13aaa47642f39b8fdfff927ab');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_password' => 'pgresql',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'localhost',
            'mailer_user' => '',
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => 'a5e7b1cecdda9fb13aaa47642f39b8fdfff927ab',
            ...
            'kernel.secret' => 'a5e7b1cecdda9fb13aaa47642f39b8fdfff927ab',
