...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'port' => '5432', 'user' => 'postgres', 'password' => 'pgresql', 'driver' => 'pdo_pgsql', 'charset' => 'UTF8', 'logging' => false, 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Doctrine\Common\EventManager(), array());
    }
